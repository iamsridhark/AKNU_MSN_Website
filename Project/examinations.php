...
<!-----academic calendar------>
    <div class="container">
    <img src="images/exam.jpg" class="menu-icon">
    <div class="heading">
    <h4>EXAMINATIONS</h4>
    </div>
    ...
    <a href="download.php?file=PG IV Sem Notification July 2022-converted">PG IV Sem Notification July 2022-converted</a>
